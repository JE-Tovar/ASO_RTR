...
/// el filtro global de consulta de <c>AsoRtrDbContext.OnModelCreating</c> (nunca devuelve filas
/// de otra organizacion) y el estampado de <c>AsoRtrDbContext.SaveChanges</c> (toda fila nueva
