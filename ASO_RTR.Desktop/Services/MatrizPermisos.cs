...
/// cubren el único módulo de negocio que existe hoy (Finanzas). Ajustar en cuanto el negocio
/// real (control de calidad, limpieza, empacado, etiquetado) tenga sus propios módulos y roles.
/// </summary>
