...
///
/// PROVISIONAL: este es el scaffold reiniciado de ASO. Solo trae los permisos del armazón
/// (usuarios, peticiones, organización) y los del único módulo de ejemplo que sobrevivió
/// (Finanzas · Cuentas por Pagar y Banco). Cada módulo de negocio nuevo agrega su propia clase
/// aquí siguiendo el mismo patrón — ver la receta en CLAUDE.md.
/// </summary>
