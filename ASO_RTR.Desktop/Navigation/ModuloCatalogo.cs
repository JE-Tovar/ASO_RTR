...
namespace ASO_RTR.Desktop.Navigation;
...
///
/// PROVISIONAL: este es el scaffold reiniciado de ASO para un negocio distinto (control de
/// calidad, limpieza, empacado y etiquetado de botellas). Por ahora solo trae un único módulo
/// de negocio — Finanzas, con Cuentas por Pagar y Banco — como plantilla viva de los patrones
/// del framework (ver "Cómo se agrega un submódulo" en CLAUDE.md). Los módulos reales del
/// negocio se agregan aquí siguiendo esa receta.
/// </summary>
