...
namespace ASO_RTR.Desktop.Migrations
{
    ...
    [Migration("20260907231106_AgregarConsumoYMermaMultipleAEtapa")]
    partial class AgregarConsumoYMermaMultipleAEtapa
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.Articulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.CuentaBancaria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.Etapa", b =>
                {
                    ...
                    b.Property<string>("MermaSalidaNumero")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.MovimientoBanco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.Organizacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.PermisoUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.PeticionCambio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.TipoBotella", b =>
                {
                    ...
                    b.Property<int>("ColumnasPorNivel")
                        .HasColumnType("int");

                    b.Property<int>("FilasPorNivel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.EntradaInventario", b =>
                {
                    b.OwnsMany("ASO_RTR.Desktop.Models.EntradaInventarioLinea", "Lineas", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.FacturaProveedor", b =>
                {
                    b.OwnsMany("ASO_RTR.Desktop.Models.FacturaProveedorLinea", "Lineas", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.SalidaInventario", b =>
                {
                    b.OwnsMany("ASO_RTR.Desktop.Models.SalidaInventarioLinea", "Lineas", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("ASO_RTR.Desktop.Models.TipoBotella", b =>
                {
                    b.OwnsMany("ASO_RTR.Desktop.Models.CeldaPatronEmpaque", "PatronEmpaque", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("Columna")
                                .HasColumnType("int");

                            b1.Property<int>("Fila")
                                .HasColumnType("int");

                            b1.Property<int>("Orientacion")
                                .HasColumnType("int");

                            b1.Property<int>("Patron")
                                .HasColumnType("int");
                            ...
                            b1.HasIndex("TipoBotellaId");

                            b1.ToTable("CeldaPatronEmpaque");

                            b1.WithOwner()
                                .HasForeignKey("TipoBotellaId");
                        });

                    b.Navigation("PatronEmpaque");
                });
