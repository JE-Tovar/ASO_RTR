...
public class AsoRtrDbContext : DbContext
{
    ...
    public AsoRtrDbContext() => _organizacionId = Ambito.OrganizacionId;
    ...
    {
        var plantilla = typeof(AsoRtrDbContext).GetMethod(
    ...
    /// <c>BD/</c> nadie construye un <c>AsoRtrDbContext</c>—, así que ninguna acción puede
